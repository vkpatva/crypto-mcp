# chain-read Specification

## Purpose

Defines the read-only blockchain query tools: native and ERC-20 balances, gas price, block and transaction lookups, ENS resolution, and generic contract view calls.
