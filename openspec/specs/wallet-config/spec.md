# wallet-config Specification

## Purpose

Defines how the server loads its signing wallet and required configuration from the environment, including key material (mnemonic or private key), the Alchemy API key, secret hygiene, and default network selection.
